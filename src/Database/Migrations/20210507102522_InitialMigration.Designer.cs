...
namespace Database.Migrations
{
    ...
    [Migration("20210507102522_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Database.Entities.Identity.Person", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Database.Entities.Core.Bank.BankProfile", b =>
                {
                    b.HasOne("Database.Entities.Identity.Person", "Person")
                        .WithOne("BankProfile")
            ...
            modelBuilder.Entity("Database.Entities.Identity.User", b =>
                {
                    b.HasOne("Database.Entities.Identity.Person", "Person")
                        .WithOne("User")
                        .HasForeignKey("Database.Entities.Identity.User", "PersonId");
